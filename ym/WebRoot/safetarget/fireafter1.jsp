...
$(document).ready(function() {
	 $.ajax({
			url:'${ctx}/safeTarget/safeTargetAction!getById?id=<%=id%>',
...
<center>
<div id="Layer1">
<span style="font-family:Arial;font-size:28px;font-weight:normal;font-style:normal;text-decoration:none;color:#333333;">煤矿火灾发生的概率</span>
<span id="gl" style="font-family:Arial;font-size:28px;font-weight:normal;font-style:normal;text-decoration:none;color:#FF0000;"></span>
...
<div id="tb1" style="display: none;">
	...
	<div style="padding-left:0px; height:10px;">
  ...
  <table border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td width="7%" rowspan="2"><div align="center"><br />
        <strong>符号</strong><strong> </strong> </div></td>
      <td width="23%" rowspan="2"><p align="center"><strong>事件名称</strong><strong> </strong></p></td>
      <td width="23%" rowspan="2"><p align="center"><strong>基本事件影响因素</strong><strong> </strong></p></td>
