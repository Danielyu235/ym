...
<div id="operateWin" iconCls="icon-save" title="操作">
    ...
    <div id="functionDiv">
		<form id="functionForm" style="padding: 10px 20px 10px 85px;">
			<table cellpadding="5px" style="font-size:12px;" cellpadding="5px" style="font-size:12px;">
	    		<tr class="typeOne">
	    			<td>关联表单</td>
	    			<td><input id="formId" type="text" name="menuOpt.formId" style="width:155px"/></td>	
	    		</tr>
	    		<tr class="typeOne" id="funcParaTr">
	    			<td>Url参数</td>
	    			<td><input id="urlPara" type="text" name="menuOpt.urlPara" validtype="likeJsonStr" required="true" style="width:155px"/></td>	
	    		</tr>
	    		<tr class="typeThree">
	    			<td>事件名称</td>
	    		...
	    		<tr class="typeTwo">
	    			<td>批量sql语句</td>
	    			<td><textarea style="width:300px;height:160px" id="sqlContent" name="menuOpt.funcContent"></textarea></td>	
	    		</tr>
	    		<tr class="typeThree">
	    			<td>事件内容</td>
	    			<td><textarea style="width:300px;height:160px" id="funcContent" name="menuOpt.funcContent"></textarea></td>	
	    		</tr>
	    		<tr class="typeOne">
	    			<td>打开方式</td>
	    			<td><input id="openType" type="text" name="menuOpt.openType"  style="width:155px"/></td>	
	    		</tr>
	    		<tr>
	    			<td>	    				
	    			</td>
	    			<td>
	    			<input type="hidden" name="menuOpt.id" id="menuOptId2"/>
	    			<a href="#" class="easyui-linkbutton" icon="icon-save" onclick="funcSubmit()">提交</a>
	...
	<div id="uploadDiv" >
		<form id="uploadForm" method="post" action="${ctx }/menuOpt/upload.action" enctype="multipart/form-data" target="uploadFrame" style="padding: 10px 20px 10px 85px;" >
	    	<table  cellpadding="5px" style="font-size:12px;">
				<tr>
	    			<td>是否定制页面</td>
	    			<td><input id="displayType" type="text" name="menuOpt.displayType"/></td>	
	    		</tr>
    			<tr class="typeFour">
	    			<td>打开方式</td>
	    		...
	    		<tr id="uploadTr">
	    			<td>上传模板</td>
	    			<td id="uploadTd"><input id="templateFile" style="width:200px" type="file" name="templateFile" />
	    		...
	    		<tr>
	    			<td></td>
	    			<td>
	    				<a href="#" class="easyui-linkbutton" icon="icon-save" onclick="uploadSubmit()">确认</a>
	    			</td>
	    		</tr>
	    	</table>
