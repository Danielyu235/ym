...
<div id="wrap">
	<div id="top_icon">
		...
		<h4>(分类显示：<select name="icon_leibie" onchange="searchIconList(this.value);" style="width: 120px">
			            <option value="">--</option>
		...
		<div id="box_icon">
          ...
          <s:iterator value="iconList"  id="icon">
				<div class="icon">
					<ul>
						<li>
							<a href="javascript:selectIcon('${icon.icon_id}','${icon.icon_type }');" class="lightbox">
