...
<div style="height: 500px">
    ...
    <table id="data_list" loadMsg="正在努力拉取数据中..."
        ...
        <tr>
            ...
            <th field="fieldLength" width="150" title="实体类型" align="center"
            	...
            	formatter="showFieldLength"
            	>字段长度</th>
            <th field="defaultValue" width="150" title="默认值" editor="text" align="center">缺省值</th>
            ...
            <th field="id" width="120" title="实体id" formatter="gridFormatter" align="center">操作</th>
        </tr>
        </thead>
    </table>
</div>
...
<div id="dataWin">
	...
	<div id="search" style="padding-top: 3px;">   
    	描述<input type="text" id="txtRemark"   style="width:80px"></input>  
