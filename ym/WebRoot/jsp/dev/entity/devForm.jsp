	...
	<table id="data_list" >
		<thead>
			<tr>
				...
				<th field="initType" width="150" title="" align="center" formatter="initTypeView">初始化状态</th>
...
<div id="addWin" iconCls="icon-save" title="添加表单">
    ...
    <form style="padding: 10px 20px 10px 85px;" id="addForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>表单名称</td><td><input id="addFormName" name="devForm.formName"/></td>	
    		</tr>
    		<tr>
    			<td>表或视图名称</td><td><input  id="addEntityId" name="devForm.entityId" style="width:155px"/></td>
    		</tr>
    		<tr>
    			<td>初始化状态</td>
    			<td>
    				<input id="addInitType" name="devForm.initType" style="width:155px"/>			
    			</td>
    		</tr>
    	</table>
...
<div id="searchWin" iconCls="icon-save" title="搜索表单">
    <form style="padding: 10px 20px 10px 85px;" >
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>表&nbsp;&nbsp;&nbsp;单&nbsp;&nbsp;&nbsp;名:</td><td><input class="easyui-validatebox" id="searchFormName" name="formName"/></td>	
    		</tr>
    		<tr>
    			<td>表或试图名:</td><td><input class="easyui-validatebox" id="searchEntityCode" name="entityCode"/></td>	
    		</tr>
    	</table>
        <div style="padding: 0px;">
        	<a href="#" class="easyui-linkbutton" icon="icon-search" onclick="searchSubmitForm();">确定</a>
            <a href="#" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin()">取消</a>
        </div>
    </form>
</div>
<!-- 搜索窗口 -->
...
<div id="updateWin" iconCls="icon-save" title="修改表单">
    <form style="padding: 10px 20px 10px 85px;" id="updateForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>表单名称</td><td><input id="updateFormName" name="devForm.formName"/></td>	
    		</tr>
    		<tr>
    			<td>表或视图名称</td><td><input  id="updateEntityId" name="devForm.entityId" style="width:155px"/></td>
    		</tr>
    		<tr>
    			<td>初始化状态</td>
    			<td>
    				<input  id="updateInitType" name="devForm.initType" style="width:155px"/>			
    			</td>
    		</tr>
    	</table>
        <div style="padding: 0px;">
        	<input id="updateFormId" type="hidden"  class="easyui-validatebox" name="devForm.id" value=""/>
...
<div id="menuWin" iconCls="icon-edit" title="生成菜单">
	<form id="menuForm" action="">
		<table cellpadding="5px" style="font-size:12px">
			<tr>
    			<td>菜单名称</td><td><input id="menuName" name="menu.menuName"/></td>	
    		</tr>
    		<tr>
    			<td>上级菜单</td><td><input  id="menuSjbh" name="menu.menuSjbh" style="width:155px"/></td>
    		</tr>
    		<tr>
    			<td>菜单路径</td><td><input  id="menuUrl" name="menu.menuUrl"/></td>
    		</tr>
    		<tr>
				<td class="tdInfo1">显示图标：</td>
				<td class="tdInfo2"><div ID="imgDiv" style="display: none"><img border="0" ID="imgShow" width="62" height="51" /></div>
				<input type="hidden" ID="imgOne" name="menu.menuIcon"/><input id="selectImgButton" type="button" value="选择" onClick="selectImages();"/></td>
			</tr>
			<tr>
				<td><a id="menuSubmit" href="#" class="easyui-linkbutton" icon="icon-ok" onclick="submitMenu();">确定</a></td>
				<td><a id="menuCancel" href="#" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();">取消</a></td>
			</tr>
		</table>
		 <div style="padding: 0px;">
        	<input id="menuId" type="hidden" name="menu.menuId" value=""/>           
        	<input id="_formId" type="hidden" name="devForm.id" value=""/>   
        </div>
	</form>
</div>
</body>
