...
<script type="text/javascript" src="${ctx}/resources/js/jquery/easyui-1.3.1/datagrid-detailview.js"></script>
...
<body>
	...
	<div class="datagrid-toolbar">
		...
		<a href="javascript:delFunction()" style="float: left;" class="l-btn l-btn-plain">
			<span class="l-btn-left">
...
<div id="addWin" iconCls="icon-save" title="添加表">
    ...
    <form style="padding: 10px 20px 10px 85px;" id="addForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>选择表类型</td>
    			<td>主表<input name="tableType" type="radio" value="0" checked="checked" onclick="setTableType(0)"/>&nbsp;&nbsp;从表<input name="tableType" type="radio" value="1"  onclick="setTableType(1)"/></td>
    		</tr>
    		<tr id="selectTableTr" style="display:none">
				<td>选择主表</td><td><input id="tableSelect" name="parentTableId" style="width: 155px"></td>
    		</tr>
    		<tr>
    			<td>表名</td><td><input  id="addTreeEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>表含义</td><td><input class="easyui-validatebox"  id="addTreeEntityName" name="entity.entityName"/></td>
    		</tr>
    	</table>
        <div style="padding: 0px;">
        	<input type="hidden" name="entity.entityType" value="0"/>
            <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-ok" onclick="addSubmitForm(this);return false;">确定</a>
            <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();return false;">取消</a>
        </div>
    </form>
...
<div id="addTreeNodeWin">
	<form style="padding:10px 20px 10px 85px" id="addTreeForm" method="post">
		<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>主表</td>
    			<td><label id="treeParentTableName"></label><input name="tableType" type="hidden" value="1"/><input id="treeParentTableId" name="parentTableId" type="hidden"/></td>
    		</tr>
    		<tr>
    			<td>表名</td><td><input class="easyui-validatebox" id="addEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>表含义</td><td><input class="easyui-validatebox"  id="addEntityName" name="entity.entityName"/></td>
    		</tr>
    	</table>
        <div style="padding: 0px;">
        	<input type="hidden" name="entity.entityType" value="0"/>
...
<div id="updateWin" iconCls="icon-save" title="更新表">
    <form style="padding: 10px 20px 10px 85px;" id="updateForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>父表名</td><td><label id="updateParentCode"></label> </td>	
    		</tr>
    		<tr>
    			<td>表名</td><td><input class="easyui-validatebox" id="updateEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>表含义</td><td><input class="easyui-validatebox"  id="updateEntityName" name="entity.entityName"/></td>
    		</tr>
    	</table>
		<input type="hidden" name="entity.id" id="updateEntityId"/>
        <div style="padding: 0px;">
            <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-ok" onclick="updateSubmitForm();return false;">确定</a>
            <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();return false;">取消</a>
        </div>
    </form>
</div>
...
<div id="viewWin" iconCls="icon-save" title="查看表信息">
    <form style="padding: 10px 20px 10px 85px;" id="updateForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>父表名</td><td><label id="viewParentCode"></label> </td>	
    		</tr>
    		<tr>
    			<td>表名</td><td><input class="easyui-validatebox" id="viewEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>表含义</td><td><input class="easyui-validatebox"  id="viewEntityName" name="entity.entityName"/></td>
    		</tr>
    	</table>
        <div style="padding: 0px;">
            <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();return false;">取消</a>
...
<div id="searchWin" iconCls="icon-save" title="搜索表">
    <form style="padding: 10px 20px 10px 85px;" >
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>表&nbsp;&nbsp;&nbsp;&nbsp;名:</td><td><input class="easyui-validatebox" id="searchEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>表含义:</td><td><input class="easyui-validatebox" id="searchEntityName" name="entity.entityName"/></td>	
    		</tr>
    	</table>
        ...
        <div style="padding: 0px;">
        	<a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-search" onclick="searchSubmitForm();return false;">确定</a>
            <a href="javascript:void(0);" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();return false;">取消</a>
        </div>
    </form>
</div>
