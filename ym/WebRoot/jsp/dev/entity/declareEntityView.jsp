...
<div style="height: 80%">
    <table id="data_list" >
        ...
        <tr>
            ...
            <th field="id" width="120" title="实体id" align="center" formatter="gridFormatter">操作</th>
        </tr>
        </thead>
    </table>
</div>
...
<div id="addWin" iconCls="icon-save" title="添加视图">
    ...
    <form style="padding: 10px 20px 10px 85px;" id="addForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>视图名</td>
    			<td><input class="easyui-validatebox"  id="addEntityCode" name="entity.entityCode"
    				data-options="required:true, validType:'codechick'"/></td>
    			
    		</tr>
    		<tr>
    			<td>视图含义</td>
    			<td><input class="easyui-validatebox"  id="addEntityName" name="entity.entityName"
    		...
    		<tr>
    			<td colspan="2">
    				<div>create view [<label id="codeLabel">视图名</label>] as</div>
    				<textarea rows="10" cols="33" class="easyui-validatebox" id="addViewSql" name="entity.viewSql"
    				data-options="required:true, validType:'minLength[20]'"></textarea>
    			</td>
    		</tr>
    	</table>
        <div style="padding: 0px;">
        	<input type="hidden" name="entity.entityType" value="1"/>
...
<div id="updateWin" iconCls="icon-save" title="">
    <form style="padding: 10px 20px 10px 85px;" id="updateForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>实体名</td><td><input class="easyui-validatebox" id="updateEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>实体含义</td><td><input class="easyui-validatebox"  id="updateEntityName" name="entity.entityName"/></td>
    		</tr>
    	</table>
...
<div id="viewWin" iconCls="icon-save" title="查看视图">
    <form style="padding: 10px 20px 10px 85px;" >
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>视图名</td><td><input class="easyui-validatebox" id="viewEntityCode" name="entity.entityCode"/></td>	
    		</tr>
    		<tr>
    			<td>视图含义</td><td><input class="easyui-validatebox"  id="viewEntityName" name="entity.entityName"/></td>
    		</tr>
    		<tr>
    			<td>创建视图语句</td><td></td>
    		</tr>
    		<tr>
    			<td colspan="2">
    				<textarea readonly="readonly" rows="10" cols="30" class="easyui-validatebox" id="viewSql" name="entity.viewSql"></textarea>
    			</td>
    		</tr>
    	</table>
...
<div id="fieldListWin" iconCls="icon-search" title="视图字段信息">
	  <table id="field_list"  loadMsg="正在努力拉取数据中..." >
        ...
        <tr>
            ...
            <th field="isNull" width="150" title="实体类型" align="center"  formatter="showIsNull">可否为空</th>
        </tr>
        </thead>
    </table>
</div>
...
<div id="searchWin" iconCls="icon-search" title="搜索视图">
    <form style="padding: 10px 20px 10px 85px;" id="searchForm">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>视&nbsp;&nbsp;图&nbsp;&nbsp;名:</td><td><input class="easyui-validatebox" id="searchEntityCode" name="entity.entityCode" /></td>	
    		</tr>
    		<tr>
    			<td>视图含义:</td><td><input class="easyui-validatebox" id="searchEntityName" name="entity.entityName"/></td>	
    		</tr>
    	</table>
        <input type="hidden" name="entity.id" id="viewEntityId"/>
        ...
        <div style="padding: 0px;">
        	<a href="#" class="easyui-linkbutton" icon="icon-search" onclick="searchSubmitForm();return false;">确定</a>
            <a href="#" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();return false;">取消</a>
        </div>
    </form>
</div>
