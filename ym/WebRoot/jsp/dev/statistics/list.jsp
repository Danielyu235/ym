...
<div style="height: 500px">
    <table id="data_list" class="easyui-datagrid" loadMsg="正在努力拉取数据中..."
        ...
        <tr>
            ...
            <th field="charttype" width="150" title="实体类型" formatter="gridFormatterType">统计图类型</th>
...
<div id="addWin" iconCls="icon-save" title="添加统计信息">
    ...
    <form style="padding: 10px 20px 10px 85px;" id="addForm" method="post">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>统计图标题</td><td><input class="easyui-validatebox" name="entity.charttitle"/></td>	
    		</tr>
    		<tr>
    			<td>x轴标题</td><td><input class="easyui-validatebox"  name="entity.xtitle"/></td>
    		</tr>
    		<tr>
    			<td>y轴标题</td><td><input class="easyui-validatebox"  name="entity.ytitle"/></td>
    		</tr>
    		<tr>
    			<td>统计图类型</td>
    			<td>    			
    			<select name="entity.charttype">
    		...
    		<tr>
    			<td>SQL语句</td><td>
    			<textarea class="easyui-validatebox"  name="entity.sqlcommand" rows="10"></textarea>
    			</td>
    		</tr>
    	</table>
...
<div id="viewWin" iconCls="icon-save" title="查看信息">
    <div style="padding: 10px 20px 10px 85px;">
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>统计图标题</td><td><span class="easyui-validatebox" name="entity.charttitle"/></td>	
    		</tr>
    		<tr>
    			<td>x轴标题</td><td><span class="easyui-validatebox"  name="entity.xtitle"/></td>
    		</tr>
    		<tr>
    			<td>y轴标题</td><td><span class="easyui-validatebox"  name="entity.ytitle"/></td>
    		</tr>
    		<tr>
    			<td>统计图类型</td>
    			<td>
    			<select id="charttype_view" name="entity.charttype">
    			<option value="1">2D饼图</option>
    			<option value="2">3D饼图</option>
    			<option value="3">2D柱状图</option>
    			<option value="4">3D柱状图</option>
    		...
    		<tr>
    			<td>调换顺序</td>
    			<td>
    			<select id="transposed_view" name="entity.transposed">
    			<option value="false">否</option>
    			<option value="true">是</option>
    			</select>
    			</td>
    		...
    		<tr>
    			<td>SQL语句</td><td><span class="easyui-validatebox"  name="entity.sqlcommand"/></td>
    		</tr>
    	</table>
		<input type="hidden" name="entity.id" id="updateEntityId"/>
        <div style="padding: 0px;">
...
<div id="picWin" iconCls="icon-save" title="查看信息">
    <div style="padding: 10px 20px 10px 85px;">    	
    	<iframe id="img_chart" frameborder="0" width="450px" height="350px" src="" scrolling="no"></iframe>
        <div style="padding: 0px;">
...
<div id="searchWin" iconCls="icon-save" title="查看信息">
    <form style="padding: 10px 20px 10px 85px;" >
    	<table cellpadding="5px" style="font-size:12px;">
    		<tr>
    			<td>统计图标题</td><td><input class="easyui-validatebox" id="charttitle" name="charttitle"/></td>	
    		</tr>
