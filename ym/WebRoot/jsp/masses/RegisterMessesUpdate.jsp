...
$(document).ready(
 	function (){
 		grid = new Grid('${ctx}/registerMesses/registerMessesAction!list?registerMesses.state=0', 'data_list');
		grid.loadGrid();
		crud = new Crud({
			grid:grid, 
			...
			afterUpdateLoadData:function(addFormObject, data){//加载update触发的事件
				...
				$.each(data,function(i,item){
					...
					if(i == "threeColorForm"){
						...
						$("#addForm").find('[name="registerMesses.threeColorForm"]').val("白色");
					}
					if(i == "hiddenType"){
						if(item == "C类"){
						...
						$("#addForm").find('[name="registerMesses.hiddenType"]').val("C类");
					}
					if(i=="state"){
						$("#state").val("1");
					}
	...
	<body>
			...
			<div>
				<form id="searchForm" method="post" style="display: inline;">
					<div style="margin-top: -8px;">
						&nbsp;&nbsp;发现人:&nbsp;&nbsp;
						<input type="text" name="registerMesses.find" />
						&nbsp;&nbsp;发现单位:&nbsp;&nbsp;
						<input type="text" name="registerMesses.foundUnit" />
						&nbsp;&nbsp;发现时间:&nbsp;&nbsp;
						<input type="text" class="easyui-my97 easyui-validatebox"
							data-options="readOnly:true" name="registerMesses.registerTime" />
						&nbsp;&nbsp;
		...
		<div style="height: 74%;">
			<table id="data_list" style="display: none">
				<thead>
					<tr>
						<th align="center" field="theUnit" width="50"
							formatter="gridFormatterLength">
							隐患所在单位
						</th>
						<th align="center" field="registerTime" width="80"
							formatter="gridFormatterLength">
							发现时间
						</th>
						<th align="center" field="place" width="150"
							formatter="gridFormatterLength">
							隐患地点
						</th>
						<th align="center" field="foundUnit" width="150"
							formatter="gridFormatterLength">
							发现单位
						</th>
						<th align="center" field="find" width="50"
							formatter="gridFormatterLength">
							发现人
						</th>
						<th align="center" field="post" width="80"
							formatter="gridFormatterLength">
							职务
						</th>
						<th align="center" field="content" width="200"
							formatter="gridFormatterLength">
							隐患内容
						</th>
						<th align="center" field="id" width="120"
		...
		<div style="display: none;">
			<div id="addForm" style="width: 900px; height: 450px;"
				...
				<form method="post">
					...
					<input type="hidden" name="registerMesses.state" id="state"/>
					<div style="padding: 10px 20px 10px 20px;" name="addDiv"
						...
						<fieldset class="test" id="append">
							...
							<table id="detailTable" cellpadding="5px"
								style="font-size: 12px; margin: 0 auto;" cellspacing="1"
								bgcolor="#aed0ea" width="95%" class="appendTable">
								<tr>
									...
									<td class="table_con" width="25%">
										<input type="hidden" class="easyui-validatebox"
											name="registerMesses.threeColorForm" value="白色"
											id="threeColors" />
										<input type="text" class="easyui-validatebox"
											name="registerMesses.theUnit"
											data-options="validType:'maxByteLength[100]'" value="新景矿" />
										<input type="hidden" class="easyui-validatebox"
											name="registerMesses.hiddenType" id="hiddentTypes" value="C类" />
									</td>
									<td class="table_nemu_new" width="25%">
										发现时间
									</td>
									<td class="table_con" width="25%">
										<input type="text" class="easyui-my97 easyui-validatebox"
											...
											name="registerMesses.registerTime" />
									</td>
								</tr>
								<tr>
									<td class="table_nemu_new" width="25%">
								...
								<tr>
									...
									<td colspan="3" class="table_con">
										<textarea name="registerMesses.content"
											style="width: 97%; height: 70px;"
											data-options="validType:'maxByteLength[255]'"></textarea>
									</td>
								</tr>
							</table>
						</fieldset>
