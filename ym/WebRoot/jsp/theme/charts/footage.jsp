...
<head>
	...
	<script type="text/javascript">
	    ...
	    function init(month){
	    	$.ajax( {
					type : 'post',
					url : '${ctx}/coalzt/coalztAction!getTunnlle',
	    	...
	    	$('#container').highcharts({
	            ...
	            tooltip: {
	                ...
	                pointFormat: '<tr><td style="padding:0">{series.name}: </td>' +
	                    '<td style="padding:0"><b style="color:black;">{point.y:.1f}（吨）</b></td></tr>',
	                footerFormat: '</table>',
	                shared: true,
	                useHTML: true,
	            ...
	            series: [{
	                name: '<b style="color:white;">日产</b>',
	                data: data[2],
	                color: '#FF6666'
	            }, {
	                name: '<b style="color:white;">计划产量</b>',
	                data: data[1],
	    			color: '#FFFF66'
	            }, {
...
<body>
	...
	<div>
		<form action="">
			<label style="font-size: 12px; ">按月统计进尺煤产量</label><input type="text" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" class="Wdate" name="coalzt.month" id="month" />
