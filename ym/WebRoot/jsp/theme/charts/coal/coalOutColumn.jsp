...
var title = "";
    ...
    function init(month){
    	$.ajax( {
				type : 'post',
				url : '${ctx}/coalOutput/coalOutputAction!getMonthCoalDataColumn',
        ...
        $('#container').highcharts({
            ...
            tooltip: {
                ...
                pointFormat: '<tr><td style="color:{series.color};font-size:2px;">{series.name}: </td>' +
                    '<td style="font-size:2px;text-align:right;"><b>{point.y} （吨）</b></td></tr>',
                footerFormat: '</table>',
                shared: true,
                useHTML: true,
...
<div>
	<form action="">
		<label style="font-size: 12px;color: ">按年份统计煤产量</label><input type="text" onfocus="WdatePicker({dateFmt:'yyyy'})" class="Wdate" name="elect.ysrq" id="month" />
