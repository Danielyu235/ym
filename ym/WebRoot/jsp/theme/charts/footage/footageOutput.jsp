...
<div id="con">
  <ul id="tags">
    <li class=selectTag><a href="javascript:void(0)" onClick="selectTag('tagContent0',this)">进尺煤产量折线图</a> </li>
    <li><a href="javascript:void(0)" onClick="selectTag('tagContent1',this)">进尺煤产量柱状图</a> </li>
  </ul>
  <div id="tagContent">
    <!-- 第一标签位 -->
    <div class="tagContent  selectTag" id="tagContent0">
    	<iframe src="footageLine.jsp" width="100%;" height="100%;" style="overflow: hidden;" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowTransparency="true"></iframe>
    </div>
    <!-- 第二标签位 -->
    <div class="tagContent" id="tagContent1">
   		<iframe src="footageColumn.jsp" width="100%;" height="100%;" style="overflow: hidden;" frameborder="no" border="0" marginwidth="0" marginheight="0" scrolling="no" allowTransparency="true"></iframe>
    </div>
  </div>
</div>
<p>
