...
$(document).ready(
 	function (){
 	   ...
 	   //onloadCombobox('${ctx}','ssgzm',$('#updWorkingFaceId'),null,null);//加载添加，修改页面combobox数据
 		grid = new Grid('${ctx}/coalzt/coalztAction!list?coalzt.type=1', 'data_list');
		grid.loadGrid();
		crud = new Crud({
			grid:grid, 
...
<div class="panel-header" style="width:100%;">
		<div class="panel-title panel-with-icon">采煤系统列表</div>
	...
	&nbsp;&nbsp;组别:&nbsp;&nbsp;<input type="text" class="easyui-validatebox" name="coalzt.group_type" />
