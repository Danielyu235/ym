...
$(document).ready(function (){
	 		...
	 		grid = new Grid('${ctx}/coal/coalAction!list', 'data_list', {
			...
			crud = new Crud({
				...
				entityName:'coal',
				moduleName:'采煤专业',
				url:'${ctx}/coal/coalAction',
				afterViewLoadData:function(viewFormObject, data) {
					$(viewFormObject).find('span[name="coal.craft"]').text(data.craftTypeName);
				}
			});
			...
			$('#craft').combobox({  
				url: '${ctx}/data/dataAction!findAllChildren.action?parentId='+'3853760e3e1842d6a4b8cf1baa4298ed',
				valueField:'id',
		        textField:'dataName'
		 		});
...
function expFunction() {
	...
	var id_s = "'"+ids.join("','")+"'";
	$('#searchForm').attr('action','${ctx}/coal/coalAction!exp?id='+id_s);
...
<div class="panel-header" style="width:100%;">
		<div class="panel-title panel-with-icon">采煤专业列表</div>
	...
	<div class="datagrid-toolbar" id = "tb" style="padding-left:0px; height:10px;">
	 <div>
            ...
            <div style="margin-top:-8px;">
				&nbsp;&nbsp;危险源:&nbsp;&nbsp;<input type="text" name="coal.dangerous"style="width: 120px;" />
				&nbsp;&nbsp;可能造成的伤害和损失:&nbsp;&nbsp;<input type="text" name="coal.loss" style="width: 100px;"/>
				&nbsp;&nbsp;当事人应该采取的措施:&nbsp;&nbsp;<input type="text" name="coal.step" style="width: 100px;"/>
				&nbsp;&nbsp;适用岗位:&nbsp;&nbsp;<input name="coal.craft" id="craft"style="width: 120px;"/>
	...
	<div style="display: none;">
		...
		<form method="post" >
	     ...
	     <input type="hidden" name="coal.station" value="采煤专业"/>
		    <div style="padding: 10px 20px 10px 20px;" align="center" name="addDiv" id="addDiv">
				<table id="detailTable" cellpadding="5px" style="font-size:12px;" cellspacing="1"  border="0" bgcolor="#aed0ea" width="95%">
						<tr class="remove" style="height: 140px;">
							...
							<textarea name="coal.sszyByType" style="height: 80px;width:100%;overflow-y:hidden;overflow-x:hidden;border:0;text-align: center;font-size: 28px;" readonly="readonly"></textarea>
							<textarea name="coal.ssgzByType" style="height: 80px;width:100%;overflow-y:hidden;overflow-x:hidden;border:0;text-align: center;font-size: 28px;" readonly="readonly"></textarea>
							</td>
						</tr>
						<tr class="remove">
						...
						<tr class="remove" style="height: 140px;">
							...
							<textarea name="coal.czyl" style="height: 80px;width:100%;overflow-y:hidden;overflow-x:hidden;border:0" readonly="readonly"></textarea>
							</td>
						</tr>
						<tr class="remove">
						...
						<tr class="remove" style="height: 140px;">
							<td class="table_con" colspan="4">
							<textarea name="coal.ksyd" style="height: 80px;width:100%;overflow-y:hidden;overflow-x:hidden;border:0" readonly="readonly"></textarea>
							</td>
						</tr>
						<tr class="remove">
						...
						<tr class="remove" style="height: 140px;">
							<td class="table_con" colspan="4">
							<textarea name="coal.sgal" style="height: 80px;width:100%;overflow-y:hidden;overflow-x:hidden;border:0" readonly="readonly"></textarea>
							</td>
						</tr>
						<tr>
							<td class="table_nemu_new" width="25%" style="text-align: left;">适用专业</td>
							<td class="table_con" width="25%">
							<input type="text" class="easyui-validatebox" data-options="validType:'maxByteLength[100]'" style="width:100%;border:0;" value="采煤专业" readonly="readonly"/>
							</td>
							<td class="table_nemu_new" width="25%" style="text-align: left;">适用岗位</td>
							<td class="table_con" width="25%">
							<input type="text" name="coal.craft" id="updatecraft" editable = "false" style="width:100%;" required="true"/>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<textarea class="easyui-validatebox" name="coal.dangerous" style="height: 80px;width:100%;" required="true"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="table_con" colspan="4">
							<textarea class="easyui-validatebox" name="coal.loss" style="height: 80px;width:100%;" required="true"></textarea>
							</td>
						</tr>
						<tr>
						...
						<tr>
							<td class="table_con" colspan="4">
							<textarea class="easyui-validatebox" name="coal.step" style="height: 80px;width:100%;" required="true"></textarea>
							</td>
						</tr>
				</table>
			</div>
