			...
			<div style="padding: 10px 20px 10px 20px;" align="center" name="addDiv">
				<table id="detailTable" cellpadding="5px" style="font-size:12px;"
				 cellspacing="1"  border="0" bgcolor="#aed0ea" width="95%">
						...
						<tr>
							<td class="table_nemu_new" width="25%">题目答案</td>
							<td class="table_con"  width="25%">
							<input type="text" class="easyui-combobox" data-options="valueField: 'label',
							textField: 'value',
							data: [{
								label: 'A',
								value: 'A'
								...
								label: 'D',
								value: 'D'
					        }],panelHeight:'auto',editable:false"  name="questionCredit.qsAnswer" />
							</td>
								<td class="table_nemu_new" width="25%">岗位类型</td>
							<td class="table_con" width="25%">
