	...
	<div class="datagrid-toolbar" id = "tb" style="padding-left: 0px; height:10px;">
		<div>
	        <form id="searchForm" method="post" style="display: inline;">
				...
				&nbsp;&nbsp;<a href="javascript:void(0);" class="easyui-linkbutton" onclick="publish();">整体评估</a>
		        </div>
	        </form>
		</div>
	</div>
  ...
  function getArgs() {
	   ...
	   return theRequest;                              
	    ...
	    function openPerson(id){
			...
			$.ajax({
		        ...
		        success:function (data) {
		        	...
		        	$("#messageContext").val("在"+data.accidentOfTime+",发生了"+data.bigText+",地址："+data.accidentOfPlace+"  救援工作已经结束,解除警报.");
		        }
		    });
	    }
	    ...
	    function publish(){
	    	...
	    	//alert(idText);
	    	parent.viewChildFunction('/ym/jsp/AccidentConclusion/accidentView.jsp?aid='+idText,'事故总结');
	    }
	</script>
</body>
</html>