...
<script type="text/javascript">
        ...
        function updateFunction(rowId) {
        	$.loding();
    		$.ajax({
                url:'${ctx}/tran/tranAction!getById?id=' + rowId,
                method:'POST',
                success:function (data) {
                	var obj = {};
                	...
                	$('#addForm').dialog({
            			...
            			buttons:[{
            				...
            				handler:function() {
            					$('#addForm').form('submit',{
            						url:'${ctx}/tran/tranAction!update',
            		                success:function(data) {
            						$('#addForm').dialog('close');
            		                	var data = eval('(' + data + ')');
            		                    if (data.operateSuccess) {
        ...
        function viewFunction(rowId) {
    		...
    		$.ajax({
                ...
                success:function (data) {
                	$.each(data,function(i,item){
                		$('#viewForm span[name="tran.'+i+'"]').html(item);
                    });
                	$.loded();
                	$('#viewForm').dialog({
        				title:'查看窗口',
            ...
            if (rows.length == 0) {
                ...
                $.messager.confirm('警告', '是否要删除该记录?', function (r) {
                    if (r) {
                        ...
                        $.ajax({
                            url:'${ctx}/tran/tranAction!delete?ids=' + ids,
                            method:'POST',
                            success:function(data) {
                            	var data = eval('(' + data + ')');
                                if (data.operateSuccess) {
...
<!-- 	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-exp', plain:true" onclick="expFunction()">导出</a> -->
	...
	&nbsp;&nbsp;工作面:&nbsp;&nbsp;<input type="text" name="tran.workFace" />
	&nbsp;&nbsp;统计时间:&nbsp;&nbsp;<input type="text" name="tran.statisticalTime" />
	&nbsp;&nbsp;无故障运行天数:&nbsp;&nbsp;<input type="text" name="tran.turns" />
	&nbsp;&nbsp;workFaceByName:&nbsp;&nbsp;<input type="text" name="tran.workFaceByName" />
...
<div style="height: 500px">
    <table id="data_list" loadMsg="正在努力拉取数据中..." fit="true" fitColumns="true">
        ...
        <tr>
            ...
            <th align="center" field="workFace" width="150" formatter="gridFormatterLength" >工作面</th>
            <th align="center" field="statisticalTime" width="150" formatter="gridFormatterLength" >统计时间</th>
            <th align="center" field="turns" width="150" formatter="gridFormatterLength" >无故障运行天数</th>
            <th align="center" field="workFaceByName" width="150" formatter="gridFormatterLength" >workFaceByName</th>
			...
			<div style="margin: 0 auto;" align="center" name="addDiv">
				<table class="detailTable" style="width: 80%;">
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="tran.workFace"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">统计时间:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="tran.statisticalTime"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						
						<tr>
							<td class="labelTd">无故障运行天数:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="tran.turns"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">workFaceByName:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="tran.workFaceByName"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
