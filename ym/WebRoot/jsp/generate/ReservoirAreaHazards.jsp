...
<script type="text/javascript">
        ...
        function addFunction() {
    		...
    		$('#addForm').dialog({
    			...
    			buttons:[{
    				...
    				handler:function() {    					
    					$('#addForm').form('submit',{
    		                url:'${ctx}/reservoirAreaHazards/reservoirAreaHazardsAction!add',
        ...
        function updateFunction(rowId) {
        	$.loding();
    		$.ajax({
                url:'${ctx}/reservoirAreaHazards/reservoirAreaHazardsAction!getById?id=' + rowId,
                method:'POST',
                success:function (data) {
                	var obj = {};
                	$.each(data,function(i,item){
                		obj["reservoirAreaHazards."+i] = item;
                    });
                	...
                	$('#addForm').dialog({
            			...
            			buttons:[{
            				...
            				handler:function() {
            					$('#addForm').form('submit',{
            						url:'${ctx}/reservoirAreaHazards/reservoirAreaHazardsAction!update',
            		                success:function(data) {
            						$('#addForm').dialog('close');
            		                	var data = eval('(' + data + ')');
            		                    if (data.operateSuccess) {
        ...
        function viewFunction(rowId) {
    		...
    		$.ajax({
                ...
                success:function (data) {
                	$.each(data,function(i,item){
                		$('#viewForm span[name="reservoirAreaHazards.'+i+'"]').html(item);
                    });
                	$.loded();
                	$('#viewForm').dialog({
        				title:'查看窗口',
            ...
            if (rows.length == 0) {
                ...
                $.messager.confirm('警告', '是否要删除该记录?', function (r) {
                    if (r) {
                        ...
                        $.ajax({
                            url:'${ctx}/reservoirAreaHazards/reservoirAreaHazardsAction!delete?ids=' + ids,
                            method:'POST',
                            success:function(data) {
                            	var data = eval('(' + data + ')');
                                if (data.operateSuccess) {
		...
		$(document).ready(function () {
		     grid = new Grid($("title").html(), 'icon-edit',
		             '${ctx}/reservoirAreaHazards/reservoirAreaHazardsAction!list',
		             'data_list','#tb');
		     grid.loadGrid();
		     viewFormInit();
		});
...
<!-- 	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-exp', plain:true" onclick="expFunction()">导出</a> -->
	...
	&nbsp;&nbsp;所属单位:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.dwdm" />
	&nbsp;&nbsp;编号:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.no" />
	&nbsp;&nbsp;库区名称:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.name" />
	&nbsp;&nbsp;具体位置:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.location" />
	&nbsp;&nbsp;所处环境功能区:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.environment" />
	&nbsp;&nbsp;库区占地面积:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.area" />
	&nbsp;&nbsp;库房个数:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.size" />
	&nbsp;&nbsp;填表人:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.saveMan" />
	&nbsp;&nbsp;联系电话:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.contactPhone" />
	&nbsp;&nbsp;填表日期:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.saveTime" />
	&nbsp;&nbsp;hasMap:&nbsp;&nbsp;<input type="text" name="reservoirAreaHazards.hasMap" />
...
<div style="height: 500px">
    <table id="data_list" loadMsg="正在努力拉取数据中..." fit="true" fitColumns="true">
        ...
        <tr>
            ...
            <th align="center" field="no" width="150" formatter="gridFormatterLength" >编号</th>
            <th align="center" field="name" width="150" formatter="gridFormatterLength" >库区名称</th>
            <th align="center" field="location" width="150" formatter="gridFormatterLength" >具体位置</th>
            <th align="center" field="environment" width="150" formatter="gridFormatterLength" >所处环境功能区</th>
            <th align="center" field="area" width="150" formatter="gridFormatterLength" >库区占地面积</th>
			...
			<div style="margin: 0 auto;" align="center" name="addDiv">
				<table class="detailTable" style="width: 80%;">
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.dwdm"
						...
						<tr>
							<td class="labelTd">库区名称:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.name"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">具体位置:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.location"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						
						<tr>
							<td class="labelTd">所处环境功能区:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.environment"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">库区占地面积:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.area"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						
						<tr>
							<td class="labelTd">库房个数:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.size"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.saveTime"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="reservoirAreaHazards.hasMap"
							data-options="validType:'maxByteLength[100]'" />
							</td>
