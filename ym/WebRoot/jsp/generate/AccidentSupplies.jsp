...
<script type="text/javascript">
        ...
        function addFunction() {
    		...
    		$('#addForm').dialog({
    			...
    			buttons:[{
    				...
    				handler:function() {    					
    					$('#addForm').form('submit',{
    		                url:'${ctx}/accidentSupplies/accidentSuppliesAction!add',
        ...
        function updateFunction(rowId) {
        	$.loding();
    		$.ajax({
                url:'${ctx}/accidentSupplies/accidentSuppliesAction!getById?id=' + rowId,
                method:'POST',
                success:function (data) {
                	var obj = {};
                	$.each(data,function(i,item){
                		obj["accidentSupplies."+i] = item;
                    });
                	...
                	$('#addForm').dialog({
            			...
            			buttons:[{
            				...
            				handler:function() {
            					$('#addForm').form('submit',{
            						url:'${ctx}/accidentSupplies/accidentSuppliesAction!update',
            		                success:function(data) {
            						$('#addForm').dialog('close');
            		                	var data = eval('(' + data + ')');
            		                    if (data.operateSuccess) {
        ...
        function viewFunction(rowId) {
    		...
    		$.ajax({
                ...
                success:function (data) {
                	$.each(data,function(i,item){
                		$('#viewForm span[name="accidentSupplies.'+i+'"]').html(item);
                    });
                	$.loded();
                	$('#viewForm').dialog({
        				title:'查看窗口',
            ...
            if (rows.length == 0) {
                ...
                $.messager.confirm('警告', '是否要删除该记录?', function (r) {
                    if (r) {
                        ...
                        $.ajax({
                            url:'${ctx}/accidentSupplies/accidentSuppliesAction!delete?ids=' + ids,
                            method:'POST',
                            success:function(data) {
                            	var data = eval('(' + data + ')');
                                if (data.operateSuccess) {
		...
		$(document).ready(function () {
		     grid = new Grid($("title").html(), 'icon-edit',
		             '${ctx}/accidentSupplies/accidentSuppliesAction!list',
		             'data_list','#tb');
		     grid.loadGrid();
		     viewFormInit();
		});
...
<!-- 	<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-exp', plain:true" onclick="expFunction()">导出</a> -->
	...
	&nbsp;&nbsp;事故Id:&nbsp;&nbsp;<input type="text" name="accidentSupplies.acId" />
	&nbsp;&nbsp;物质名称:&nbsp;&nbsp;<input type="text" name="accidentSupplies.materialName" />
	&nbsp;&nbsp;型号:&nbsp;&nbsp;<input type="text" name="accidentSupplies.model" />
	&nbsp;&nbsp;单位:&nbsp;&nbsp;<input type="text" name="accidentSupplies.unit" />
	&nbsp;&nbsp;数量:&nbsp;&nbsp;<input type="text" name="accidentSupplies.num" />
	&nbsp;&nbsp;库号:&nbsp;&nbsp;<input type="text" name="accidentSupplies.warehouse" />
	&nbsp;&nbsp;备注:&nbsp;&nbsp;<input type="text" name="accidentSupplies.remark" />
...
<div style="height: 500px">
    <table id="data_list" loadMsg="正在努力拉取数据中..." fit="true" fitColumns="true">
        ...
        <tr>
            ...
            <th align="center" field="acId" width="150" formatter="gridFormatterLength" >事故Id</th>
	...
	<div style="display: none;">
		<form id="addForm" method="post" style="width: 960px; height: 500px;">
			<input type="hidden" name="accidentSupplies.id"/>
			<div style="margin: 0 auto;" align="center" name="addDiv">
				<table class="detailTable" style="width: 80%;">
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.acId"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">物质名称:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.materialName"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.model"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">单位:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.unit"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.num"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						
							<td class="labelTd">库号:</td>
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.warehouse"
							data-options="validType:'maxByteLength[100]'" />
							</td>
						</tr>
						...
						<tr>
							...
							<td class="contentTd">
							<input type="text" class="easyui-validatebox" name="accidentSupplies.remark"
							data-options="validType:'maxByteLength[100]'" />
							</td>
