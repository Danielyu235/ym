...
var title = "";
    ...
    function init(month){
    	$.ajax( {
				type : 'post',
				url : '${ctx}/elect/electAction!getCol',
				data : 'elect.ysrq='+month,
        ...
        $('#container').highcharts({
            ...
            tooltip: {
                ...
                pointFormat: '<tr><td style="color:{series.color};font-size:2px;">{series.name}: </td>' +
                    '<td style="font-size:2px;text-align:right;"><b>{point.y} 万千万时</b></td></tr>',
                footerFormat: '</table>',
                shared: true,
                useHTML: true,
...
<div>
	<form action="">
		<label style="font-size: 12px;color: ">按年份统计耗电量</label><input type="text" onfocus="WdatePicker({dateFmt:'yyyy'})" class="Wdate" name="elect.ysrq" id="month" />
