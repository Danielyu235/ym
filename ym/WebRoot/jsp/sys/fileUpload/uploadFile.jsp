...
<body>
	<div class="easyui-layout" data-options="fit:true" doSize="false" style="width:100%;height:100%;">
        <div data-options="region:'east',split:true,iconCls:'icon-edit'" title="文件上传" style="width:300px">
        	<div style="width:80%;margin:50px;">
	        	<div>
			        <form id="form" action="${ctx}/fileUpload/upload!uploadFile.action?relationId=${param.relationId}" enctype="multipart/form-data" method="post">
			        	<input id="fileInput" type="file" name="file" />
			        	<input type="button" onclick="formClick();" value="提交"/>
			        	<input id="reset" type="reset" style="display:none;"/>
			        </form>
			        <div>
						<div id="progress" class="easyui-progressbar" data-options="value:0" ></div>  
			        </div>
	        	</div>
        	</div>
        </div>
        <div data-options="region:'center',title:'文件列表',iconCls:'icon-save'" >  
			<div id="fileList" style="width:100%;margin:0 auto;">
				
			</div>
			<div id="fileDiv" style="display:none;width:160px;height:100px;float:left;background:#fafafa;margin:20px;border:2px solid #ccc">
