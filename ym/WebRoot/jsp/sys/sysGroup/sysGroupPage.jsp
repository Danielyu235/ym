...
<div id="addWin" iconCls="icon-save" title="添加用户组信息">
    ...
    <form style="padding: 10px 20px 10px 85px;" id="addForm">
        <p>用户组名称:<input class="easyui-validatebox" id="addGroupName" name="sysGroup.groupName" data-options="required: true" missingMessage="请输入用户组名称"/></p>

        <p>用户组描述:<input class="easyui-validatebox" id="addDescription" name="sysGroup.description" data-options="required: true" missingMessage="请输入用户组描述"/></p>
...
<div id="updateWin" iconCls="icon-save" title="修改用户组信息">
    <form style="padding: 10px 20px 10px 85px;" id="updateForm">
        ...
        <p>用户组名称:<input class="easyui-validatebox" id="updateGroupName" name="sysGroup.groupName" data-options="required: true" missingMessage="请输入用户组名称"/></p>

        <p>用户组描述:<input class="easyui-validatebox" id="updateDescription" name="sysGroup.description" data-options="required: true" missingMessage="请输入用户组描述"/></p>
...
<div id="viewWin" iconCls="icon-save" title="查看用户组信息">
    <form style="padding: 10px 20px 10px 85px;">
        <p>用户组名称:<label class="easyui-validatebox" id="viewGroupName" name="sysGroup.groupName"></label></p>
        <p>用户组描述:<label class="easyui-validatebox" id="viewDescription" name="sysGroup.description"></label></p>
        <div style="padding: 0px;">
            <a href="#" class="easyui-linkbutton" icon="icon-cancel" onclick="closeAllWin();return false;">取消</a>
        </div>
    </form>
...
<div id="searchWin" iconCls="icon-save" title="用户组信息查询">
    <form style="padding: 10px 20px 10px 85px;" id="searchForm">
        <p>用户组名称:<input class="easyui-validatebox" id="searchGroupName" name="sysGroup.groupName" /></p>
        <div style="padding: 0px;">
...
<div id="deptUserTreeWin" iconCls="icon-save" title="设置成员">
	    <div id="p" class="easyui-panel" title="部门人员树" fit="true" tools="#tt" border="false" plain="true">
	        ...
	        <br>
	       <input type="button" value="保存" onclick="setPersons();">
	    </div>
	    <div id="tt">
