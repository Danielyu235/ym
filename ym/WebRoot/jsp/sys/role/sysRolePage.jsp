...
.table_nemu{border:0px;background:#E3F1FA;font-size:13px;color:#222222;text-align:right;line-height:28px;padding-right:15px;width:40%}
.table_nemu span{font-size:15px;color:red;font-weight:bold;}
.table_con{border:0px;background:#fff;line-height:28px;padding-left:15px;width:60%}
.btn1{
     ...
     // 提交添加菜单请求
        ...
        $(document).ready(
                function () {
                    ...
                    closeAllWin();
                    grid = new Grid('角色列表', 'icon-edit',
                            '${ctx}/sysRole/sysRole!pageList.action',
...
<div class="panel-header" style="width:99%;">
	<div class="panel-title panel-with-icon">角色列表</div>
	<div class="panel-icon icon-edit"></div>
	<div class="panel-tool"></div>
</div>
<div class="datagrid-toolbar" id="tb" style="padding-left:0px; height:30px;">
    <form id="searchForm" method="post" style="display: inline;">
    	&nbsp;&nbsp;角色名称:&nbsp;&nbsp;<input class="easyui-validatebox" id="searchRoleName" name="sysRole.roleName" />
...
<div style="height:72%">
    ...
    <table id="data_list">
        ...
        <tr>
            ...
            <th field="id" width="70%" title="操作" formatter="gridFormatter" align="center">操作</th>
        </tr>
        </thead>
    </table>
</div>
    ...
    <form  style="padding: 10px 20px 10px 20px;" id="addForm" method="post">
	    <table cellpadding="5px" style="font-size:12px;" cellspacing="1"  border="0" bgcolor="#aed0ea">
	   		<tr>
				...
				<td class="table_con"><input class="easyui-validatebox" id="addRoleName" name="sysRole.roleName" data-options="required: true,validType:'length[0,25]',invalidMessage:'输入的内容不能超过25个字符'" missingMessage="请输入角色名称"/></td>
			</tr>
			<tr>
				<td class="table_nemu">角色描述</td>
				<td class="table_con"><input class="easyui-validatebox" id="addDescription" name="sysRole.description" data-options="required: true,validType:'length[0,100]',invalidMessage:'输入的内容不能超过100个字符'" missingMessage="请输入角色描述"/></td>
			</tr>
		</table>
		<br/>
	        <div align="center">
...
<div id="updateWin" iconCls="icon-save" title="修改角色信息">
     <form  style="padding: 10px 20px 10px 20px;" id="updateForm"  method="post">
	    ...
	    <table cellpadding="5px" style="font-size:12px;" cellspacing="1"  border="0" bgcolor="#aed0ea">
	   		<tr>
				<td class="table_nemu">角色名称:</td>
				<td class="table_con"><input class="easyui-validatebox" id="updateRoleName" name="sysRole.roleName" data-options="required: true,validType:'length[0,25]',invalidMessage:'输入的内容不能超过25个字符'" missingMessage="请输入角色名称"/></td>
			</tr>
			<tr>
				<td class="table_nemu">角色描述</td>
				<td class="table_con"><input class="easyui-validatebox" id="updateDescription" name="sysRole.description" ata-options="required: true,validType:'length[0,100]',invalidMessage:'输入的内容不能超过100个字符'" missingMessage="请输入角色描述"/></td>
			</tr>
				</table>
				<br/>
	        <div align="center" >
...
<div id="viewWin" iconCls="icon-save" title="查看角色信息">
    <form  style="padding: 10px 20px 10px 20px;">
	    <table cellpadding="5px" style="font-size:12px;" width="80%" align="center" cellspacing="1"  border="0" bgcolor="#aed0ea">
	   		<tr>
				<td class="table_nemu">角色名称:</td>
				<td class="table_con"><label class="easyui-validatebox" id="viewRoleName" name="sysRole.roleName"></label></td>
			</tr>
			<tr>
				<td class="table_nemu">角色描述</td>
				<td class="table_con"><label class="easyui-validatebox" id="viewDescription" name="sysRole.description"></label></td>
			</tr>
			</table>
			<br/>
	        <div align="center">
...
<div id="menuOptTreeWin" iconCls="icon-save" title="设置菜单权限">
	    <div id="p" class="easyui-panel" title="菜单权限树" fit="true" tools="#tt" border="false" plain="true">
	        <div id="menu_opt_tree_search" style="display: none">关键字:<input type="text" id="key" name="key" style="width:80px;"/><a
	        ...
	        <br>
	      <p align="center"> <a href="#" class="easyui-linkbutton" icon="icon-ok"  value="保存" onclick="saveMenuOpt();">保存</a></p>
	    </div>
</div>
<form  style="height:0%;weight:0%" id="roleMenuOptForm">
		<input type="hidden" id="menuOptsStr" name="menuOptsStr"/>
		<input type="hidden" id="menuOptRoleId" name="menuOptRoleId"/>
</form>
...
<div id="deptTreeWin" iconCls="icon-save" title="部门授权">
    <div id="p" class="easyui-panel" title="部门树" fit="true" tools="#tt" border="false" plain="true">
        ...
        <br>
         <p align="center" id="roleDeptSave"> <a href="#" class="easyui-linkbutton" icon="icon-ok"  value="保存" onclick="saveRoleDept();">保存</a></p>
         <p align="center" id="roleDataDeptSave"> <a href="#" class="easyui-linkbutton" icon="icon-ok"  value="保存" onclick="saveRoleDataDept();">保存</a></p>
    </div>
</div>
<form  style="height:0%;weight:0%" id="roleDeptForm">
		<input type="hidden" id="roleDeptsStr" name="roleDeptsStr"/>
		<input type="hidden" id="deptRoleId" name="deptRoleId"/>
</form>
<!-- 部门人员树展现 -->
<div id="deptUserTreeWin" iconCls="icon-save" title="用户授权">
	    <div id="p" class="easyui-panel" title="部门人员树" fit="true" tools="#tt" border="false" plain="true">
	        <div id="dept_user_tree_search" style="display: none">关键字:<input type="text" id="key" name="key" style="width:80px;"/><a
	                href="#" class="easyui-linkbutton" iconCls="icon-search" plain="true"
	                onclick="tree.searchNode();">搜索</a></div>
	        <div id="dept_user_tree" class="ztree"></div>
	        <br>
         <p align="center" id="roleUserSave"> <a href="#" class="easyui-linkbutton" icon="icon-ok"  value="保存" onclick="setPersons();">保存</a></p>
         <p align="center" id="roleDataUserSave"> <a href="#" class="easyui-linkbutton" icon="icon-ok"  value="保存" onclick="saveRoleDataUser();">保存</a></p>
	    </div>
</div>
...
<div id="roleGroupWin" iconCls="icon-save" title="用户组授权">
    <form  id="roleGroupForm" style="padding: 10px 20px 10px 10px;">
        <div id="roleGroupList" algin="left">
        </div>
        <input type="hidden" id="groupsStr" name="groupsStr"/>
		<input type="hidden" id="groupRoleId" name="groupRoleId"/>
    </form>
</div>
...
<div id="roleDataWin" iconCls="icon-save" title="数据权限设置">
	 <table id="role_data_list">
        ...
        <tr>
            ...
            <!--  <th field="description" width="30%" title="角色描述">角色描述</th>-->
            <th field="id" width="70%" title="操作" formatter="roleDataGridFormatter" align="center">操作</th>
        </tr>
        </thead>
    </table>
</div>
