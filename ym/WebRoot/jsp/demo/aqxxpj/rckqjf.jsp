...
<div style="height:78%;">
    <table class="easyui-datagrid" style="display:none" fitColumns=true pagination=true fit="true">
        ...
        <tr>
            ...
            <th field="number" width="150px" align="center" title="number">奖惩状况</th>
            <th field="numbers" width="150px" align="center" title="numbers">奖惩原因</th>
...
<div id="addWin" iconCls="icon-save" title="添加日常考勤与奖罚信息">
    <form  style="padding: 10px 20px 10px 20px;" id="addForm"  method="post" >
	  ...
	  <tr >
	   ...
	   <tr >
	    ...
	    <td class="table_nemu_new" >奖惩状况</td>
	    <td class="table_con" ><input class="easyui-combobox" data-options="valueField: 'label',
				textField: 'value',
				data: [{
					label: '处罚',
	  ...
	  <tr height="100">
	    <td class="table_nemu_new" width="25%">奖惩原因</td>
