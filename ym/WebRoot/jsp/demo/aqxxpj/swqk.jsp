...
<body>
  ...
  <div class="panel-header" style="width:100%;">
	<div class="panel-title panel-with-icon">三违情况</div>
...
<div style="height:78%;">
    <table class="easyui-datagrid" style="display:none" fitColumns=true pagination=true fit="true">
        <thead>
        <tr>
         <th field="carStyle" width="100" align="center" title="carStyle">工号</th>
            <th field="carName" width="100" align="center" title="carName">姓名</th>
            <th field="carModle" width="100" align="center" title="carModle">部门</th>
            <th field="number" width="100" align="center" title="number">三违罚款次数</th>
             <th field="numbers" width="100" align="center" title="numbers">三违罚款金额</th>
            <th  field="id" width="100" align="center" formatter="gridFormatter">操作</th>     
        </tr>
        </thead>
        <tbody>
          <tr>
    ...
    <form  style="padding: 10px 20px 10px 20px;" id="addForm"  method="post" >
	  ...
	  <tr >
	   ...
	   <tr >
	    ...
	    <td class="table_nemu_new" >三违罚款次数</td>
	    ...
	    <td class="table_con" ><input class="easyui-datebox" name="rescueCars.number" /></td>	   
	 </tr>
	  <tr height="100">
