...
$(document).ready(
 	function (){
 		grid = new Grid('${ctx}/hiddenPerils/hiddenPerilsAction!listPerils?hiddenDanger.status=1', 'data_list', {
...
<div class="panel-header" style="width:100%;">
	...
	<div style="height:74%;">
	    <table id="data_list" style="display:none">
            ...
            <!-- th align="center" field="majorText" width="150" formatter="gridFormatterLength" >隐患专业</th -->
