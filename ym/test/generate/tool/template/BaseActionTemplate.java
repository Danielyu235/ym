...
public class BaseActionTemplate implements ITemplate
{
  ...
  protected final String TEXT_10 = ";" + NL + "\tprivate String page;" + NL + "\tprivate String rows;" + NL + "\tprivate String sort;" + NL + "\tprivate String order;" + NL + "\tprivate String id;" + NL + "\tprivate String ids;" + NL + "\t" + NL + "\tpublic void add() {" + NL + "\t\tOperateInfo operateInfo = new OperateInfo();" + NL + "\t\ttry {" + NL + "\t\t\t";
  ...
  protected final String TEXT_23 = "Service.getById(id)," + NL + "\t\t\t\tEncodingHeaderUtil.HEADERENCODING," + NL + "\t\t\t\tEncodingHeaderUtil.CACHEENCODING);\t\t" + NL + "\t}" + NL + "\t" + NL + "    public ";
