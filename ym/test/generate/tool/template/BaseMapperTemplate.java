...
public class BaseMapperTemplate implements ITemplate
{
  ...
  protected final String TEXT_2 = "\">" + NL + "\t<!-- 查询条件 -->" + NL + "\t<sql id=\"mapWhereClause\">" + NL + "\t\t<isParameterPresent>" + NL + "\t\t\t<isNotEmpty prepend=\"and\" property=\"id\"> ";
  ...
  protected final String TEXT_19 = NL + "\t\t\t\t" + NL + "\t\t\t\tID," + NL + "\t\t\t\tSTATUS," + NL + "\t\t\t\tCREATED," + NL + "\t\t\t\tCREATE_TIME," + NL + "\t\t\t\tUPDATED," + NL + "\t\t\t\tUPDATE_TIME) values(" + NL + "\t\t\t\t";
  protected final String TEXT_20 = NL + "\t\t\t\t#";
  protected final String TEXT_21 = "#,";
  protected final String TEXT_22 = NL + "\t\t\t\t" + NL + "\t\t\t\t#id#," + NL + "\t\t\t\t#status#," + NL + "\t\t\t\t#created#," + NL + "\t\t\t\t#createTime#," + NL + "\t\t\t\t#updated#," + NL + "\t\t\t\t#updateTime#)" + NL + "\t</insert>" + NL + "\t<!-- add method delete-->" + NL + "\t<delete id=\"delete\" parameterClass=\"java.lang.String\">" + NL + "\t\tUPDATE ";
