...
import com.ay.hazards.hazardousmaterials.service.MaterialsService;
import com.ay.framework.core.action.BaseAction;
/** 
 * @Description 危化品库的中危险物质Action
 * @date 2013-4-15
 * @author WangXin
 */
...
public class MaterialsAction extends BaseAction {
	...
	public void delete() {
		...
		if (ids.contains(",")) {
			...
			flag = materialsService.delete(idsParam);
		} else {
			flag = materialsService.delete(ids);
		}
		if (flag) {
	...
	public void list() {
		...
		Map paramMap = BeanUtil.Bean2Map(materials);
		Page resultPage = materialsService.pageQuery(paramMap, pageTemp);
	...
	public void getById() {
		Struts2Utils.renderJson(materialsService.getById(id),
