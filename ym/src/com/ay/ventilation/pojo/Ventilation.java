package com.ay.ventilation.pojo;
...
/**
 * 煤矿危险源库（专业部分，通风安全专业）实体类
 * @author qianjinhao
 * 2013年5月20日 
 */
//@ChineseName("通风安全专业")
public class Ventilation extends BasePojo
{
    @ChineseName("序号")
	...
	public String toString() {
		return "Ventilation [corpKey=" + corpKey + ", craft=" + craft
				+ ", craftTypeName=" + craftTypeName + ", czyl=" + czyl
				+ ", dangerous=" + dangerous + ", ksyd=" + ksyd + ", loss="
				+ loss + ", sgal=" + sgal + ", ssgzByType=" + ssgzByType
				+ ", sszyByType=" + sszyByType + ", station=" + station
				+ ", step=" + step + "]";
	}
