 ...
 * 所谓内存分页只是针对小数据量的简单封装，在处理分页时我们只针对结果集合进行分页。 2.数据库层分页。 所谓数据层分页，只针对sql中实现最根本的分页，对于巨大数据量能
 * @author lushigai
 * @version 1.0
 * @Date:2012-9-10
 * 修改人：lijie
 * 修改时间：2013-1-21
 * 修改内容：添加根据当前页与页面显示条数返回分页page对象
 */
public class Page
{
    /***/
    ...
    /**
     * 
     * @param formName 表单name名称formName
     */
     ...
     * 每页记录数
     * 
     * @param prePageNum The prePageNum to set.
     */
